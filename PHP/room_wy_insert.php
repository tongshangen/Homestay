...
header('Access-Control-Allow-Origin:*');
    ...
    $sql = "insert into room(room_name,room_position,nearby,room_size,room_type,max_people,price,device,bed,wc) values('$room_name','$room_position','$nearby','$room_size','$room_type',$max_people,$price,'$device',$bed,$wc)";
